...
stargazer(one, two, three, four, five, type = 'latex', font.size = "tiny", header = FALSE, covariate.labels=c("Elected Superintendent", "Pct Students in Poverty",  "Student-to-Teacher Ratio", "Enrollment", "Elected:Enrollment"))
