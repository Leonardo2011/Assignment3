...
Variables <- c('Enrolled100s', 'Student-to-Teacher Ratio',  
                'Poverty Percentage', 'Graduation Rates', 'Composite Score',      'Mean Algebra', 
...
library(stargazer)
stargazer(simpleclean, type='latex', digits = 1, header=FALSE, title = "Summary Stats for All Districts")
...
stargazer(simpleappointed, type='latex', digits = 1, title = "Summary Stats for Appointed Districts", header = FALSE)  
...
ggtitle("Algebra II Distribution")
```
...
**Y(i)[Student Outcome]** = **X0** + **X1(i)[Elected]** + **X2(i)[Enrolled100s]** + **X3(i)[Poverty Pct.]** + **X4(i)[Student-to-Teacher Ratio]** + **(X1(i) * X2(i))[Elected * Total Enrollment]**  + **Eo**
...
library(stargazer)
stargazer(together, type='latex', title = "Predicted Values", header = FALSE, summary = FALSE)
